			...
			<form className='row' onSubmit={FormSent}>
				<div className="mb-3 row">
					...
					<div className="col-sm-10">
						<input type="email" placeholder='Enter your E-mail' className="form-control" id="Email"
							   onChange={(e) => setText(prev => ({...prev, mail: e.target.value}))}/>
					</div>
				</div>
				<div className="mb-3">
					<label htmlFor="Textarea" className="form-label">Message:</label>
					<textarea placeholder='Message to Kwon Valerii' value={text.text} className="form-control"
							  id="Textarea" rows={5}
							  onChange={(e) => setText(prev => ({...prev, text: e.target.value}))}></textarea>
				</div>
